...
st.set_page_config(page_title="Genres - Creuzflix", layout="wide", initial_sidebar_state="collapsed")
...
st.title("📂 Sélection par genres")

genres = ["Action", "Comédie", "Drame", "Science-fiction", "Horreur"]
choix = st.selectbox("Choisissez un genre :", genres)

st.markdown(f"### 🎞️ Films du genre : {choix}")
